    ...
    <div class="table-list">
        <form action="" method="post">
            ...
            <table width="100%" class="table_form ">
                ...
                <tr>
                    <th width="200">栏目ID：</th>
                    <td><input type="text" class="input-text" style="width:50px;" value="<?php echo $data['cat_id']?>" name="data[listorder]"></td>
                </tr>
                ...
                <tr id="fine_setting_thumb">
                    <th>上传高亮图片：</th><td><input type="text" class="input-text" size="50" value="" name="data[hover_pic]" id="fc_setting_thumb"  />
                        <input type="button" style="width:66px;cursor:pointer;" class="button" onClick="preview('fc_setting_thumb')" value="预览" />
                        <input type="button" style="width:66px;cursor:pointer;" class="button" onClick="uploadImage('fc_setting_thumb','','','300')" value="上传" /><span id="ck_setting_thumb"></span></td></tr><tr id="fine_setting_url"><th>链接地址：</th><td><input type="text" value="" class="input-text" name="data[setting_url]"  style='width:300px;'  />
                        <span id="ck_setting_url"></span></td>
                </tr>
                <tr>
                    <th></th>
