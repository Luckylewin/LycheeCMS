    ...
    <div class="table-list">
        <form action="" method="post">
            ...
            <table width="100%" class="table_form ">
                ...
                <tr>
                    <th width="200">小标题：</th>
                    <td><input type="text" class="input-text" style="width:200px;" value="<?php echo $data['sub_name']?>" name="data[sub_name]"></td>
                </tr>

                <tr>
                    <th width="200">序号：</th>
                    <td><input type="text" class="input-text" style="width:50px;" value="<?php echo $data['listorder']?>" name="data[listorder]"></td>
                </tr>
                ...
                <tr>
                    ...
                    <td id="bindcat">
                        ...
                        <select class="cat" name="data[catid]" id="bindcat" <?php if($action=='edit') echo "disabled='disabled'"; ?> style="<?php if($action=='edit') echo 'color:grey;'?>" >
                            <?php
                            $str = '';
                            foreach ($cat as $key => $c) {
                                $select = $c['catid'] == $data['catid'] ? "selected=selected":"";
                                $str .= "<option value='{$c['catid']}' {$select}> {$c['catname']}</option>";
                            }
                            echo $str;
                            ?>
                        </select>
                ...
                <tr id="fine_setting_thumb">
                    <th>上传默认图片：</th><td><input type="text" class="input-text" size="50" value="<?php echo $data['default_pic']?>" name="data[default_pic]" id="fc_setting_thumb"  />
                ...
                <tr id="fine_setting_thumb">
                    <th>上传高亮图片：</th><td><input type="text" class="input-text" size="50" value="<?php echo $data['hover_pic']?>" name="data[hover_pic]" id="fc_setting_thumb"  />
                        <input type="button" style="width:66px;cursor:pointer;" class="button" onClick="preview('fc_setting_thumb')" value="预览" />
                        <input type="button" style="width:66px;cursor:pointer;" class="button" onClick="uploadImage('fc_setting_thumb','','','300')" value="上传" /><span id="ck_setting_thumb"></span></td></tr><tr id="fine_setting_url"><th>链接地址：</th><td>
