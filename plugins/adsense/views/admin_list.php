...
<table width="100%">
	...
	<tr height="25">
      ...
      <a class="flood" style="display:none" href="<?php echo purl('admin/flood/',array('aid'=>$t[id]));?>">|&nbsp;批量添加</a>
      <a class="flood" style="display:none" href="<?php echo purl('admin/floodbind/',array('aid'=>$t[id]));?>">|&nbsp;一键绑定</a>
...
<button style="float:right;margin-top:330px;" onclick="var flood = document.getElementById('flood');flood.style.display='block';" id="lychee">.</button>
<script>
	$(function(){
		$('#lychee').click(function()
		{
			 $('.flood').show();
		})
	})
