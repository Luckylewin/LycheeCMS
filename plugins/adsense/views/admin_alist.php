...
<a href='<?php echo purl("admin/alist", array('aid'=>$aid))?>' class="on"><em>广告管理</em></a><span>|</span>
<a href='<?php echo purl("admin/adda", array('aid'=>$aid))?>'><em>添加广告</em></a><span>|</span>
...
<table width="100%">
	...
	<tr>
	  <th width="50" align="right">选择&nbsp;<input name="deletec" id="deletec" type="checkbox" onClick="setC()">&nbsp;</th>
		...
		<th width="150" align="left">绑定栏目</th>
	...
	<tr height="25">
      ...
      <a href="<?php echo purl('admin/disabled/',array('id'=>$t[id]));?>"><?php echo $t['disabled'] ? "<font color=red>启用</font>" : "禁用";?></a>
      </td>
	  </tr>
      <?php } ?>
	<tr height="25">
