...
<table width="100%" class="table_form ">
	<tr>
        ...
        <td><input type="text" placeholder="不绑定栏目时必须填写名称" class="input-text" style="width:200px;" value="<?php echo $data['name']?>" name="data[name]"></td>
    </tr>
    
    <tr>
        <th width="200">栏目绑定(最多支持三级栏目)：</th>
        <td id="bindcat">
